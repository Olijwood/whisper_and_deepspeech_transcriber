...
def main():
    ...
    f.write("DeepSpeech Transcription: ")
    ...
    for txt_file in os.listdir(dir_path + '/processed_audio/'):
        if txt_file.endswith('.txt'):
            if not os.path.isdir(f'{dir_path}/deepspeech_transcription'):
                os.mkdir(f'{dir_path}/deepspeech_transcription')
            shutil.move(f'{dir_path}/processed_audio/{txt_file}', f'{dir_path}/deepspeech_transcription/{txt_file}')
    ...
    for file in os.listdir(f"{dir_path}/unformatted_audio/"):
        os.remove(f'{dir_path}/unformatted_audio/{file}')
